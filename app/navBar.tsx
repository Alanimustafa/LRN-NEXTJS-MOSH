  ...
  return (
    <>
        <div className="flex bg-#cc3fc-100 border-1 border-orange-500 rounded-lg p-4 ">
            ...
            { status === 'authenticated' && session?.user?.email && <Link href='/api/auth/' className=" px-4 py-2  text-orange-200 border-4 border-gray-300 rounded-md  hover:bg-orange-200 hover:text-black hover:border-4 hover:border-orange-200 cursor-pointer mr-5">{session.user.email}</Link>}
            ...
            { status ==='unauthenticated' && (<button
              ...
              <Link href='/help' className="px-4 py-2 bg-orange-500 text-black border-4 border-gray-300 rounded-md  hover:bg-black hover:text-orange-500 hover:border-4 hover:border-orange-500 cursor-pointer mr-5">Help</Link>
        </div>
    </>
  )
}
